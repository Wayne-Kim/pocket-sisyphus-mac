...
> Une app macOS qui permet de contrôler en toute sécurité Claude Code (Codex CLI et Gemini CLI bientôt disponibles) tournant sur votre Mac depuis votre téléphone.
> Propulsée par les **services onion Tor** · **zéro serveur** · **zéro service payant** · **composants 100% OSS**.
