...
1. (Mac) पहले लॉन्च पर daemon स्वचालित रूप से एक Tor onion service बनाता है (`xxxxx.onion`)।
2. (Mac) मेनू बार आइकन → **Show Pairing QR**।
3. (फोन) पहली बार लॉन्च होने पर iOS का **Pocket Sisyphus** ऐप आपसे **कनेक्शन मोड** चुनने को कहता है — “कहीं से भी (Tor)” या “केवल वही Wi-Fi”।
4. (फोन) पेयर करने के लिए QR स्कैन करें।
   - **कहीं से भी** — फोन कहीं से भी (LTE/5G/Wi-Fi) Tor नेटवर्क के माध्यम से Mac से जुड़ता है।
   - **केवल वही Wi-Fi** — फोन और Mac के एक ही Wi-Fi पर होने पर ही निजी एड्रेस से सीधे जुड़ता है (तेज़), और बाहरी नेटवर्क पर कनेक्शन ब्लॉक करता है।
...
- **केवल वही Wi-Fi मोड (वैकल्पिक)** — चालू होने पर यह केवल उसी Wi-Fi पर निजी एड्रेस से जुड़ता है और Tor, सार्वजनिक IP, तथा सभी बाहरी outbound को ब्लॉक करता है (fail-closed)। जब आपको यह गारंटी चाहिए कि कोई पैकेट आपके स्थानीय नेटवर्क से बाहर न जाए।
...
**पेयरिंग विफल**
→ “कहीं से भी (Tor)” मोड में फोन और Mac को एक ही Wi-Fi पर होना ज़रूरी नहीं है (LTE/5G भी ठीक है), बस iOS के **Pocket Sisyphus.app** ने Tor बूटस्ट्रैप पूरा कर लिया हो (प्रगति ऐप में दिखती है)। “केवल वही Wi-Fi” मोड में फोन और Mac का एक ही Wi-Fi पर होना अनिवार्य है।
